          ...
          <div class="header">
            <aside class="sidebar">
              <div class="sidebar-inner">
                ...
                <nav class="sidebar-nav col-md-2">
                  <button type="button">
...
$tambah = mysqli_query($koneksi, "SELECT * FROM produk WHERE kategori='horror'");
        ...
        <article class="card h-100 shadow-sm" style="border: none; overflow: hidden; transition: transform 0.3s ease;">
            ...
            <div class="card-footer bg-transparent border-top-0">
                <div class="text-center">
                    <a class="btn btn-outline-primary mt-auto" href="detail.php?id=<?= $produk['id'] ?>">DETAIL</a>
                </div>
            </div>
        </article>
    </div>
