...
$sql = "SELECT t.id_transaksi, u.nama, t.total, t.tanggal,
...
<html lang="en" data-bs-theme="auto">
  ...
  <body>
    <!-- SVG definitions dan dropdown theme selector tetap sama -->
...
<div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2 active" href="db-history.php">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>
                                ...
                                <td><img src='../foto/" . clean_output($row["foto"]) . "' alt='" . clean_output($row["nama_produk"]) . "' class='img-thumbnail' width='50'></td>
                              </tr>";
                    }
                } else {
